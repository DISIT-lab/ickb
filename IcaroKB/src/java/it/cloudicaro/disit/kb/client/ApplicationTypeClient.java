...
/**
 * Jersey REST client generated for REST resource:ApplicationTypeResource<br>
 * USAGE:
 * <pre>
 *        ApplicationTypeClient client = new ApplicationTypeClient();
...
public class ApplicationTypeClient {
  ...
  public ApplicationTypeClient(String baseUri, String name) {
    client = javax.ws.rs.client.ClientBuilder.newClient();
    String resourcePath = java.text.MessageFormat.format("applicationType/{0}", new Object[]{name});
