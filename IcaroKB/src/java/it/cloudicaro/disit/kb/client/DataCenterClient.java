...
/**
 * Jersey REST client generated for REST resource:DataCenterResource<br>
 * USAGE:
 * <pre>
 *        DataCenterClient client = new DataCenterClient();
...
public class DataCenterClient {
  ...
  public DataCenterClient(String baseUri, String id) {
    client = javax.ws.rs.client.ClientBuilder.newClient();
    String resourcePath = java.text.MessageFormat.format("dataCenter/{0}", new Object[]{id});
    webTarget = client.target(baseUri).path(resourcePath);
  }

  public void setResourcePath(String baseUri, String id) {
    String resourcePath = java.text.MessageFormat.format("dataCenter/{0}", new Object[]{id});
    webTarget = client.target(baseUri).path(resourcePath);
  }
