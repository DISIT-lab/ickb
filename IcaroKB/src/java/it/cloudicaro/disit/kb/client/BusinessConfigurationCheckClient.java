 ...
 * @author bellini
 */
public class BusinessConfigurationCheckClient {

  private WebTarget webTarget;
  private Client client;
  private static final String BASE_URI = "http://localhost:8080/IcaroKB/api";

  public BusinessConfigurationCheckClient(String baseUri) {
    client = javax.ws.rs.client.ClientBuilder.newClient();
    webTarget = client.target(baseUri).path("businessConfigurationCheck");
  }

  public BusinessConfigurationCheckClient(String baseUri, String username, String password) {
    this(baseUri);
